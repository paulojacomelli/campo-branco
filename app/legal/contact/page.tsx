        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <section className="space-y-8 text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-surface dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-surface-border dark:border-slate-700 text-center space-y-2">
                    ...
                    <a href="mailto:campobranco@paulojacomelli.com.br" className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-light hover:text-primary-dark dark:hover:text-primary transition-colors block break-all">
                        campobranco@paulojacomelli.com.br
                    </a>
